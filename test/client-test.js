...
const miaugram = require('../')
const fixtures = require('./fixtures')

let options = {
  endpoints: {
    pictures: 'http://miaugram.test/picture',
    users: 'http://miaugram.test/user',
    auth: 'http://miaugram.test/auth'
  }
}

test.beforeEach(t => {
  t.context.client = miaugram.createClient(options)
})
